...
== Invoicing with response

The difference between the invoicing process with response and the basic invoicing process is that in the invoicing process with response, the supplier expects the customer to send a response after receiving the invoice. 

See BIS 3 Upgrade for more information on Invoice Response 3.2 (T111).
