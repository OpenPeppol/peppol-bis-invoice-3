...
The purpose of this document is to facilitate an efficient implementation and increased use of electronic collaboration regarding the billing process with electronic and structured invoice responses.
...
This document is concerned with clarifying requirements for ensuring interoperability and provides guidelines for the support and implementation of these requirements. This BIS involves a process where there is a mandatory use of the Invoice Response. 
