...
This BIS describes a collaboration using the transactions and rules for Peppol BIS Billing 3 and Invoice Response 3 where the Invoice Response is a mandatory transaction.
