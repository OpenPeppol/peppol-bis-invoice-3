...
The diagram below shows the roles involved in the invoice and credit note and invoice response transactions. The customer and invoice receiver is the same entity, as is the supplier and the invoice sender.
