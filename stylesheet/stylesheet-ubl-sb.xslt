...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cn="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:in="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:u="utils" version="2.0" exclude-result-prefixes="cac cbc u cn in xs">
	...
	<xsl:template match="cn:CreditNote[starts-with(normalize-space(cbc:CustomizationID/text()), 'urn:cen.eu:en16931:2017#compliant#urn:fdc:peppol.eu:2017:poacc:selfbilling:3.0')]" mode="document" priority="1000">
		<html lang="{$language}">
			<head>
	...
	<xsl:template match="in:Invoice[starts-with(normalize-space(cbc:CustomizationID/text()), 'urn:cen.eu:en16931:2017#compliant#urn:fdc:peppol.eu:2017:poacc:selfbilling:3.0')]" mode="document" priority="1000">
		<html lang="{$language}">
			<head>
				<xsl:call-template name="doc-head" />
				<title>
	...
	<xsl:variable name="codelists">
		...
		<cl id="uncl1001invoice">
			...
			<c id="527">
				<t id="en">Self billed debit note</t>
			</c>
		</cl>
		<cl id="uncl1001-cn">
			<c id="261">
				<t id="en">Self billed credit note</t>
			</c>
		</cl>
	</xsl:variable>
